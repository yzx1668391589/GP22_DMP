...
//    df.registerTempTable("custom")
//    val result = sQLContext.sql("select count(*),provincename,cityname from custom group by provincename,cityname")
//    val conn: Properties = new Properties()
//    conn.setProperty("user","root")
//    conn.setProperty("password","123456")
//    df.write.jdbc("jdbc:mysql://localhost:3306/movie?useSSL=false","customer",conn)
//
//    /**
//      * sparkCore 写入数据库
//      */
